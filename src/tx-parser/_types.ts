...
export type REAddressNativeToken =
  REAddressBase<REAddressType.RADIX_NATIVE_TOKEN>
export type REAddressHashedKeyNonce =
  REAddressBase<REAddressType.HASHED_KEY_NONCE> &
    Readonly<{
      lower26Bytes: Buffer
    }>
...
export type BaseValidatorSubstate<SST extends SubStateType> =
  BaseSubstate<SST> &
    Readonly<{
      // Reserved, always 0
      reserved: Byte
...
export type BaseStakingSubstate<SST extends SubStateType> =
...
export type PreparedUnstakeT =
  BaseStakingSubstate<SubStateType.PREPARED_UNSTAKE>
export type StakeOwnershipT = BaseStakingSubstate<SubStateType.STAKE_OWNERSHIP>

export type ValidatorAllowDelegationFlagT =
  BaseValidatorSubstate<SubStateType.VALIDATOR_ALLOW_DELEGATION_FLAG> &
    Readonly<{
      isDelegationAllowed: boolean
    }>

export type ValidatorOwnerCopyT =
  BaseValidatorSubstate<SubStateType.VALIDATOR_OWNER_COPY> &
    Readonly<{
      owner: REAddressT
    }>
...
export type BaseInstructionWithSubState<IT extends InstructionType> =
  BaseInstruction<IT> &
    Readonly<{
      substate: SubstateT
    }>
