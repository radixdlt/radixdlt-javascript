 ...
 * @export
 */
export const AccountEndpointApiAxiosParamCreator = function (
...
export const AccountEndpointApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    AccountEndpointApiAxiosParamCreator(configuration)
  return {
    /**
     * Returns an account\'s available and staked token balances, given an account address. If an account address is valid, but doesn\'t have any ledger transactions against it, this endpoint still returns a successful response.
     * @summary Get Account Balances
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.accountBalancesPost(
          accountBalancesRequest,
          options,
        )
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.accountDerivePost(
          accountDeriveRequest,
          options,
        )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.accountStakesPost(
          accountStakesRequest,
          options,
        )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.accountTransactionsPost(
          accountTransactionsRequest,
          options,
        )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.accountUnstakesPost(
          accountUnstakesRequest,
          options,
        )
      return createRequestFunction(
...
export class AccountEndpointApi extends BaseAPI {
  ...
  public accountBalancesPost(
    ...
    return AccountEndpointApiFp(this.configuration)
      .accountBalancesPost(accountBalancesRequest, options)
 ...
 * @export
 */
export const GatewayEndpointApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const GatewayEndpointApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    GatewayEndpointApiAxiosParamCreator(configuration)
  return {
    /**
     * Returns the Gateway API version, network and current ledger state.
     * @summary Get Gateway Info
 ...
 * @export
 */
export const GatewayEndpointApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class GatewayEndpointApi extends BaseAPI {
  ...
  public gatewayPost(body: object, options?: AxiosRequestConfig) {
    return GatewayEndpointApiFp(this.configuration)
      .gatewayPost(body, options)
      .then(request => request(this.axios, this.basePath))
  }
}
 ...
 * @export
 */
export const TokenEndpointApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const TokenEndpointApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    TokenEndpointApiAxiosParamCreator(configuration)
  return {
    /**
     * Returns the Radix Resource Identifier of a newly created token an account with the given public key.
     * @summary Derive Token Identifier
 ...
 * @export
 */
export const TokenEndpointApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class TokenEndpointApi extends BaseAPI {
  ...
  public tokenDerivePost(
    ...
    return TokenEndpointApiFp(this.configuration)
      .tokenDerivePost(tokenDeriveRequest, options)
      .then(request => request(this.axios, this.basePath))
  }
 ...
 * @export
 */
export const TransactionEndpointApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
 ...
 * @export
 */
export const TransactionEndpointApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    TransactionEndpointApiAxiosParamCreator(configuration)
  return {
    /**
     * Returns a built unsigned transaction payload, from a set of intended actions.
     * @summary Build Transaction
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.transactionBuildPost(
          transactionBuildRequest,
          options,
        )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.transactionFinalizePost(
          transactionFinalizeRequest,
          options,
        )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.transactionRulesPost(
          transactionRulesRequest,
          options,
        )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.transactionStatusPost(
          transactionStatusRequest,
          options,
        )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.transactionSubmitPost(
          transactionSubmitRequest,
          options,
        )
      return createRequestFunction(
 ...
 * @export
 */
export const TransactionEndpointApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class TransactionEndpointApi extends BaseAPI {
  ...
  public transactionBuildPost(
    ...
    return TransactionEndpointApiFp(this.configuration)
      .transactionBuildPost(transactionBuildRequest, options)
      .then(request => request(this.axios, this.basePath))
  }
 ...
 * @export
 */
export const ValidatorEndpointApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const ValidatorEndpointApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ValidatorEndpointApiAxiosParamCreator(configuration)
  return {
    /**
     * Returns the validator address associated with the given public key.
     * @summary Get Validator Identifier
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.validatorDerivePost(
          validatorDeriveRequest,
          options,
        )
      return createRequestFunction(
 ...
 * @export
 */
export const ValidatorEndpointApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class ValidatorEndpointApi extends BaseAPI {
  ...
  public validatorDerivePost(
    ...
    return ValidatorEndpointApiFp(this.configuration)
      .validatorDerivePost(validatorDeriveRequest, options)
      .then(request => request(this.axios, this.basePath))
  }
