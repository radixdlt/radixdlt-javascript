...
import { Mnemonic, PrivateKey } from '@crypto'
import { SigningKeychain, SigningKeychainT } from '../'
import { firstValueFrom } from 'rxjs'

export const makeSigningKeyChainWithFunds =
  async (): Promise<SigningKeychainT> => {
    ...
    if (
      (
        await firstValueFrom(signingKeychain.observeActiveSigningKey())
