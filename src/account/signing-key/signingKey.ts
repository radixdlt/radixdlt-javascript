...
import { HardwareSigningKeyT } from '@hardware-wallet'
...
const makeDecrypt =
  (diffieHellman: DiffieHellman): Decrypt =>
  (input: SigningKeyDecryptionInput): Observable<string> =>
    toObservable(
...
const makeEncrypt =
  (diffieHellman: DiffieHellman): Encrypt =>
  (input: SigningKeyEncryptionInput): Observable<EncryptedMessageT> =>
    toObservable(
...
const makeEncryptHW =
  (hardwareSigningKey: HardwareSigningKeyT): Encrypt =>
  (input: SigningKeyEncryptionInput): Observable<EncryptedMessageT> =>
...
const makeDecryptHW =
  (hardwareSigningKey: HardwareSigningKeyT): Decrypt =>
  (input: SigningKeyDecryptionInput): Observable<string> =>
...
const fromPrivateKeyNamedOrFromHDPath = (
  ...
  const sign = (tx: BuiltTransactionReadyToSign, _nonXrdHRP?: string) =>
