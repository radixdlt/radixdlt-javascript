...
import { PublicKeyT, sha256Twice } from '@crypto'
import { HRP, hrpFullSuffixLength, Network } from '@primitives'
...
export const isResourceIdentifierOrUnsafeInput = (
  ...
  isResourceIdentifier(something) || isResourceIdentifierUnsafeInput(something)
