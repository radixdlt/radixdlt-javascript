    ...
    it('should be able to decrypt saved keystore', async () => {
        const keystore: KeystoreT = {
          "crypto": {
              ...
              "ciphertext": "49ce243c72077f8b7cbfbb878b2d3f78d192c93adf0e2d07772cbd32dc1b5cd44fad93d4dacdae2ccf4685",
              "kdf": "scrypt",
              "kdfparams": {
                  "costParameterN": 8192,
                  ...
                  "salt": "250dd310370eb0b571d6abce37cce6996edcedee9790e0e864132bce9c4174d1"
              },
        ...
        const decrypted = decryptedResult._unsafeUnwrap()
        expect(decrypted.toString('utf-8')).toBe('My Bitcoins are burried underneath the oak.')
    })
})