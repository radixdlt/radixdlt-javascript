...
export class DefaultApi extends runtime.BaseAPI {
     ...
     */
    async transactionFinalizePostRaw(requestParameters: TransactionFinalizePostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ConstructionFinalizeResponse>> {
        if (requestParameters.constructionFinalizeRequest === null || requestParameters.constructionFinalizeRequest === undefined) {
            throw new runtime.RequiredError('constructionFinalizeRequest','Required parameter requestParameters.constructionFinalizeRequest was null or undefined when calling transactionFinalizePost.');
        }
     ...
     * Finalize Transaction
     */
    async transactionFinalizePost(requestParameters: TransactionFinalizePostRequest, initOverrides?: RequestInit): Promise<ConstructionFinalizeResponse> {
     ...
     * Submit Transaction
     */
    async transactionSubmitPostRaw(requestParameters: TransactionSubmitPostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ConstructionSubmitResponse>> {
        if (requestParameters.constructionSubmitRequest === null || requestParameters.constructionSubmitRequest === undefined) {
            throw new runtime.RequiredError('constructionSubmitRequest','Required parameter requestParameters.constructionSubmitRequest was null or undefined when calling transactionSubmitPost.');
        }
     ...
     * Submit Transaction
     */
    async transactionSubmitPost(requestParameters: TransactionSubmitPostRequest, initOverrides?: RequestInit): Promise<ConstructionSubmitResponse> {
