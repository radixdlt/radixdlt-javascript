...
export function TokenNativeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TokenNativeResponse {
...
export function TokenNativeResponseToJSON(value?: TokenNativeResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
