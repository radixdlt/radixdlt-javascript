...
export function TransactionBuildRequestFromJSON(json: any): TransactionBuildRequest {
    return TransactionBuildRequestFromJSONTyped(json, false);
}

export function TransactionBuildRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionBuildRequest {
    ...
    return {
        ...
        'disableTokenMintAndBurn': !exists(json, 'disable_token_mint_and_burn') ? undefined : json['disable_token_mint_and_burn'],
    };
}

export function TransactionBuildRequestToJSON(value?: TransactionBuildRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
