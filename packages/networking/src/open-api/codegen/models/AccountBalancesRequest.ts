...
export function AccountBalancesRequestFromJSON(
	json: any,
): AccountBalancesRequest {
	return AccountBalancesRequestFromJSONTyped(json, false)
}

export function AccountBalancesRequestFromJSONTyped(
	json: any,
...
export function AccountBalancesRequestToJSON(
	value?: AccountBalancesRequest | null,
): any {
	if (value === undefined) {
		return undefined
	}
