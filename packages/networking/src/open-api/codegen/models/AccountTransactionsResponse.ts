...
export function AccountTransactionsResponseFromJSON(
	json: any,
): AccountTransactionsResponse {
	return AccountTransactionsResponseFromJSONTyped(json, false)
}

export function AccountTransactionsResponseFromJSONTyped(
	json: any,
...
export function AccountTransactionsResponseToJSON(
	value?: AccountTransactionsResponse | null,
): any {
	if (value === undefined) {
		return undefined
	}
