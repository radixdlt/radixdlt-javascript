...
export function CreateTokenDefinitionAllOfFromJSON(
	json: any,
): CreateTokenDefinitionAllOf {
	return CreateTokenDefinitionAllOfFromJSONTyped(json, false)
}

export function CreateTokenDefinitionAllOfFromJSONTyped(
	json: any,
	...
	return {
		...
		to: !exists(json, 'to')
			? undefined
			: AccountIdentifierFromJSON(json['to']),
	}
}

export function CreateTokenDefinitionAllOfToJSON(
	value?: CreateTokenDefinitionAllOf | null,
): any {
	if (value === undefined) {
		return undefined
	}
