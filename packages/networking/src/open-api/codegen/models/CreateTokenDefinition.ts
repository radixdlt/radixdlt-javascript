...
export function CreateTokenDefinitionFromJSON(
	json: any,
): CreateTokenDefinition {
	return CreateTokenDefinitionFromJSONTyped(json, false)
}

export function CreateTokenDefinitionFromJSONTyped(
	json: any,
...
export function CreateTokenDefinitionToJSON(
	value?: CreateTokenDefinition | null,
): any {
	if (value === undefined) {
		return undefined
	}
