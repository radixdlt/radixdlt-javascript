...
export class DefaultApi extends runtime.BaseAPI {
     ...
     */
    async tokenDerivePostRaw(requestParameters: TokenDerivePostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<TokenDeriveResponse>> {
        if (requestParameters.tokenDeriveRequest === null || requestParameters.tokenDeriveRequest === undefined) {
            throw new runtime.RequiredError('tokenDeriveRequest','Required parameter requestParameters.tokenDeriveRequest was null or undefined when calling tokenDerivePost.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: TokenDeriveRequestToJSON(requestParameters.tokenDeriveRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => TokenDeriveResponseFromJSON(jsonValue));
    }

    /**
     * Derive Token Identifier
     */
    async tokenDerivePost(requestParameters: TokenDerivePostRequest, initOverrides?: RequestInit): Promise<TokenDeriveResponse> {
        const response = await this.tokenDerivePostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async tokenNativePostRaw(requestParameters: TokenNativePostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<TokenNativeResponse>> {
        if (requestParameters.tokenNativeRequest === null || requestParameters.tokenNativeRequest === undefined) {
            throw new runtime.RequiredError('tokenNativeRequest','Required parameter requestParameters.tokenNativeRequest was null or undefined when calling tokenNativePost.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: TokenNativeRequestToJSON(requestParameters.tokenNativeRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => TokenNativeResponseFromJSON(jsonValue));
    }

    /**
     * Get Native Token Info
     */
    async tokenNativePost(requestParameters: TokenNativePostRequest, initOverrides?: RequestInit): Promise<TokenNativeResponse> {
        const response = await this.tokenNativePostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get Token Info
     */
    async tokenPostRaw(requestParameters: TokenPostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<TokenResponse>> {
     ...
     * Get Token Info
     */
    async tokenPost(requestParameters: TokenPostRequest, initOverrides?: RequestInit): Promise<TokenResponse> {
     ...
     * Build Transaction
     */
    async transactionBuildPostRaw(requestParameters: TransactionBuildPostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<TransactionBuildResponse>> {
        if (requestParameters.transactionBuildRequest === null || requestParameters.transactionBuildRequest === undefined) {
            throw new runtime.RequiredError('transactionBuildRequest','Required parameter requestParameters.transactionBuildRequest was null or undefined when calling transactionBuildPost.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: TransactionBuildRequestToJSON(requestParameters.transactionBuildRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => TransactionBuildResponseFromJSON(jsonValue));
    }

    /**
     * Build Transaction
     */
    async transactionBuildPost(requestParameters: TransactionBuildPostRequest, initOverrides?: RequestInit): Promise<TransactionBuildResponse> {
        const response = await this.transactionBuildPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async transactionFinalizePostRaw(requestParameters: TransactionFinalizePostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<TransactionFinalizeResponse>> {
        if (requestParameters.transactionFinalizeRequest === null || requestParameters.transactionFinalizeRequest === undefined) {
            throw new runtime.RequiredError('transactionFinalizeRequest','Required parameter requestParameters.transactionFinalizeRequest was null or undefined when calling transactionFinalizePost.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: TransactionFinalizeRequestToJSON(requestParameters.transactionFinalizeRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => TransactionFinalizeResponseFromJSON(jsonValue));
    }

    /**
     * Finalize Transaction
     */
    async transactionFinalizePost(requestParameters: TransactionFinalizePostRequest, initOverrides?: RequestInit): Promise<TransactionFinalizeResponse> {
        const response = await this.transactionFinalizePostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async transactionRulesPostRaw(requestParameters: TransactionRulesPostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<TransactionRulesResponse>> {
        if (requestParameters.transactionRulesRequest === null || requestParameters.transactionRulesRequest === undefined) {
            throw new runtime.RequiredError('transactionRulesRequest','Required parameter requestParameters.transactionRulesRequest was null or undefined when calling transactionRulesPost.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: TransactionRulesRequestToJSON(requestParameters.transactionRulesRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => TransactionRulesResponseFromJSON(jsonValue));
    }

    /**
     * Get Transaction Rules
     */
    async transactionRulesPost(requestParameters: TransactionRulesPostRequest, initOverrides?: RequestInit): Promise<TransactionRulesResponse> {
        const response = await this.transactionRulesPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Submit Transaction
     */
    async transactionSubmitPostRaw(requestParameters: TransactionSubmitPostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<TransactionSubmitResponse>> {
     ...
     * Submit Transaction
     */
    async transactionSubmitPost(requestParameters: TransactionSubmitPostRequest, initOverrides?: RequestInit): Promise<TransactionSubmitResponse> {
