...
/**
 * Allows a client to request a response in relation to a certain ledger position. If the version is provided, the latest ledger state <= the given version is returned. If a timestamp is provided, the latest ledger state <= the given timestamp is returned. If an epoch is provided, the ledger state at the given epoch <= the given round (else round 0) is returned.
 * @export
