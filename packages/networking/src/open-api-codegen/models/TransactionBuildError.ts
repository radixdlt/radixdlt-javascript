...
export function TransactionBuildErrorFromJSON(json: any): TransactionBuildError {
    return TransactionBuildErrorFromJSONTyped(json, false);
}

export function TransactionBuildErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionBuildError {
...
export function TransactionBuildErrorToJSON(value?: TransactionBuildError | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
