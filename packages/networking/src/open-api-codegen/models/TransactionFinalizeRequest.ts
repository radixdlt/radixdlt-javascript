...
export function TransactionFinalizeRequestFromJSON(json: any): TransactionFinalizeRequest {
    return TransactionFinalizeRequestFromJSONTyped(json, false);
}

export function TransactionFinalizeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionFinalizeRequest {
    ...
    return {
        ...
        'signature': TransactionFinalizeRequestSignatureFromJSON(json['signature']),
        'submit': !exists(json, 'submit') ? undefined : json['submit'],
    };
}

export function TransactionFinalizeRequestToJSON(value?: TransactionFinalizeRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
