...
import { handleAccountBalancesResponse, handleAccountTransactionsResponse, handleBuildTransactionResponse, handleDeriveTokenIdentifierResponse, handleNativeTokenResponse, handleNetworkResponse, handleStakePositionsResponse, handleSubmitTransactionResponse, handleTokenInfoResponse, handleTransactionRulesResponse, handleUnstakePositionsResponse, handleValidatorResponse, handleValidatorsResponse } from './responseHandlers'
...
const callAPIWith =
	...
	<DecodedResponse>(handleResponse: (response: ReturnOfAPICall<M>) => Result<DecodedResponse, Error[]>) =>
...
export const getAPI = pipe(
	...
	callAPI => ({
		...
		deriveTokenIdentifier: callAPI('tokenDerivePost')(handleDeriveTokenIdentifierResponse),
		...
		transactionRules: callAPI('transactionRulesPost')(handleTransactionRulesResponse),
		...
		// transactionStatus: callAPI('transactionStatusPost')(handleTransactionStatusResponse)
	})
)